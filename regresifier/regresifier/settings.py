"""
Django settings for regresifier project.
...
SECRET_KEY = 'django-insecure-pwez@unj$5mmh7k-n_5df1v@wu1s4jnbyk3i_7p2+)g=m-1n-&'
...
WSGI_APPLICATION = 'regresifier.wsgi.application'
